      ...
      <main className="landing-main">
        <section className="hero-mega" aria-labelledby="hero-title">
          <div className="hero-mega__grid">
            ...
            <aside className="hero-mega__card" aria-label="Example decision output">
              ...
              <div className="hero-mega__score-row">
                <div className="hero-mega__ring-wrap">
                  <div className="hero-mega__ring">
                    <div className="hero-mega__ring-inner">
                      <span className="hero-mega__score-num">78</span>
                    </div>
                  </div>
                </div>
                <div className="hero-mega__score-copy">
                  ...
                  <p className="hero-mega__score-desc">
                    Inflow stability up week-over-week · spend volatility within band ·
                    no high-risk velocity spikes in the last 30 days.
                  </p>
                </div>
              </div>
              <div className="hero-mega__stats">
                <div className="hero-mega__stat">
                  <div className="hero-mega__stat-val">+12</div>
                  <div className="hero-mega__stat-key">Income</div>
                </div>
                <div className="hero-mega__stat">
                  <div className="hero-mega__stat-val">−4</div>
                  <div className="hero-mega__stat-key">Spend</div>
                </div>
                <div className="hero-mega__stat">
                  <div className="hero-mega__stat-val">Low</div>
